...
<div class="container">
    ...
    <section>
        ...
        <div class="blog-button fadeUpTrigger">
            ...
            <a class="btn btn-more" href="blog">MORE...</a>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="column fadeUpTrigger">
            ...
            <div class="column-content">
                ...
                <p class="button">
                    <a href="about" class="button-effect bgleft">
                        <span>詳細を見る</span>
    ...
    <section>
        ...
        <div class="column fadeUpTrigger">
            ...
            <div class="column-content">
                ...
                <p class="button ">
                    <a href="menu" class="button-effect bgleft">
                        <span>詳細を見る</span>
                        <svg xmlns="http://www.w3.org/2000/svg" height="18px" width="18px" viewBox="0 0 384 650">
                            <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            <path d="M342.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L274.7 256 105.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" />
    ...
    <section id="info" class="fadeUpTrigger">
        ...
        <div class="info_3colmns row fadeUpTrigger">
            <a class="info_content col-lg-4 card-effect" href="info">

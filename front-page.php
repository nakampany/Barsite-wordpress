...
<div class="container">
                    ...
                    <article class="col-lg-4 col-sm-6" id="<?php the_ID(); ?>" <?php post_class('news'); ?>>
                        <a href="<?php the_permalink() ?>">
                            <div class="project pro-1">
                                ...
                                <?php else : ?>
                                    <img src="https://barcloud-fukui.com/wp-content/uploads/2022/12/BH7C6648-scaled.jpg" alt="">
                                <?php endif; ?>
                                <div class="overlay">
    ...
    <section>
        ...
        <div class="column fadeUpTrigger">
            ...
            <div class="column-content">
                ...
                <p class="button">
                    <a href="https://barcloud-fukui.com/about" class="button-effect bgleft">
                        <span>詳細を見る</span>
    ...
    <section>
        ...
        <div class="column fadeUpTrigger">
            <figure class="column-step">
                <img src="https://barcloud-fukui.com/wp-content/uploads/2022/12/BH7C6703-scaled.jpg" alt="">
            </figure>
            <div class="column-content">
                <p class="column-description">
                    お食事やリゾート気分を味わえるカフェ＆バー

        ...
        <div class="container">
            <nav id="" class="header-nav d-flex row align-items-center">
                ...
                <ul class="col-10 d-flex justify-content-end">
                    ...
                    <li class="sns py-3 px-3">
                        <a href="https://lin.ee/4CemrXl" class="line"><svg xmlns="http://www.w3.org/2000/svg" height="37px" width="40px" viewBox="0 0 448 512">
                    ...
                    <li class="sns py-3">
                        <a href="https://instagram.com/barcloud0801"><svg xmlns="http://www.w3.org/2000/svg" height="37px" width="40px" viewBox="0 0 448 512">
